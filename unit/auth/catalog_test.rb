...
describe Fog::TeleFonica::Auth::Catalog::V3 do
  CATALOGV3 = [
    {
      "endpoints" => [
        {
  ...
  describe '#get_endpoint_url' do
    it 'with matching name, interface and region' do
      catalog = Fog::TeleFonica::Auth::Catalog::V3.new(payload)
    ...
    it 'with matching name and interface and several regions available' do
      ...
      end.must_raise Fog::TeleFonica::Auth::Catalog::EndpointError
    end
...
describe Fog::TeleFonica::Auth::Catalog::V2 do
  CATALOGV2 = [
    {
      'endpoints'       => [{
  ...
  describe '#get_endpoint_url' do
    it 'match name, interface and region' do
      catalog = Fog::TeleFonica::Auth::Catalog::V2.new(payload)
