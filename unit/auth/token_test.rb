...
describe Fog::TeleFonica::Auth::Token do
  describe 'V3' do
    describe '#new' do
      it 'fails when missing credentials' do
        ...
        proc do
          Fog::TeleFonica::Auth::Token.build({}, {})
        end.must_raise Fog::TeleFonica::Auth::Token::URLError
      end
      ...
      describe 'using the password method' do
        describe 'with a project scope' do
          it 'authenticates using a project id' do
            auth = {
              :telefonica_auth_url   => 'http://localhost/identity',
              :telefonica_userid     => 'user_id',
              :telefonica_api_key    => 'secret',
              :telefonica_project_id => 'project_id'
            }
...
{\"id\":\"user_id\",\"password\":\"secret\"}}},\"scope\":{\"project\":{\"id\":\"project_id\"}}}}").
            ...
            token = Fog::TeleFonica::Auth::Token.build(auth, {})
          ...
          it 'authenticates using a project name and a project domain id' do
            auth = {
              ...
              :telefonica_project_domain_id => 'project_domain_id'
            }
...
\"project_domain_id\"}}}}}").
          ...
          it 'authenticates using a project name and a project domain name' do
            auth = {
              ...
              :telefonica_user_domain_name    => 'user_domain',
              :telefonica_api_key             => 'secret',
              :telefonica_project_name        => 'project',
              :telefonica_project_domain_name => 'project_domain'
            }
        ...
        describe 'with a domain scope' do
          it 'authenticates using a domain id' do
            auth = {
              ...
              :telefonica_userid    => 'user_id',
              :telefonica_api_key   => 'secret',
              :telefonica_domain_id => 'domain_id'
            }
...
\"scope\":{\"project\":{\"id\":\"project_id\"}}}}").
          ...
          it 'authenticates using a project name and a project domain id' do
            auth = {
              ...
              :telefonica_auth_token        => 'token',
              :telefonica_project_name      => 'project',
              :telefonica_project_domain_id => 'domain_id'
            }
    ...
    describe 'when authenticated' do
      let(:authv3_creds) do
        {
          ...
          :telefonica_project_domain_id => 'default'
        }
      end
      ...
      describe '#get' do
        it 'when token has not expired' do
          ...
          token = Fog::TeleFonica::Auth::Token.build(authv3_creds, {})
...
\"tenantName\":\"tenant\"}}").
        ...
        it 'authenticates using the tenant id' do
          auth = {
            ...
            :telefonica_username  => 'user',
            :telefonica_api_key   => 'secret',
            :telefonica_tenant_id => 'tenant_id',
          }
...
\"tenantId\":\"tenant_id\"}}").
      ...
      describe 'using the token method' do
        it 'authenticates using the tenant name' do
          auth = {
            :telefonica_auth_url   => 'http://localhost/identity',
            :telefonica_auth_token => 'token_id',
            :telefonica_tenant     => 'tenant',
          }
        ...
        it 'authenticates using the tenant id' do
          ...
          Fog::TeleFonica::Auth::Token.build(auth, {})
        end
      end
    end
...
[\"catalog_data\"]}}",
          ...
          token = Fog::TeleFonica::Auth::Token.build(authv2_creds, {})
          token.stub :expired?, false do
