...
=>   <Fog::Orchestration::TeleFonica::Stack
    ...
    notification_topics=[],
    outputs=[],
    parameters={"AWS::StackId"=>"arn:telefonica:heat::5d139d95546240748508b2a518aa5bef:stacks/stack4/0b8e4060-419b-416b-a927-097d4afbf26d", "AWS::Region"=>"ap-southeast-1", "AWS::StackName"=>"stack4"},
    stack_name="stack4",
    stack_status="UPDATE_COMPLETE",
    stack_status_reason="Stack successfully updated",
