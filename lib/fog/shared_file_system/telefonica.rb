  ...
  module SharedFileSystem
    class TeleFonica < Fog::Service
      ...
      recognizes :telefonica_auth_token, :telefonica_management_url,
                 ...
                 :telefonica_identity_api_version, :telefonica_shared_file_system_microversion

      model_path 'fog/shared_file_system/telefonica/models'
      model       :network
      collection  :networks
      model       :share
      collection  :shares
      ...
      request_path 'fog/shared_file_system/telefonica/requests'
      # share networks
      ...
      class Real
        ...
        def self.not_found_class
          Fog::SharedFileSystem::TeleFonica::NotFound
        end
        ...
        def initialize(options = {})
          ...
          @fixed_microversion     = options[:telefonica_shared_file_system_microversion]
          @microversion_key       = 'X-Telefonica-Manila-Api-Version'.freeze
          super
        end
      end
    end
