  ...
  module Storage
    class TeleFonica
      class Real
        ...
        # If overridden, names should be CGI escaped (excluding spaces) if needed (see {Fog::TeleFonica.escape}).
        #
        ...
        #
        # @raise [Fog::Storage::TeleFonica::NotFound] HTTP 404
        # @raise [Excon::Errors::BadRequest] HTTP 400
        # @raise [Excon::Errors::Unauthorized] HTTP 401
        # @raise [Excon::Errors::HTTPStatusError]
        #
        # @see http://docs.telefonica.org/api/telefonica-object-storage/1.0/content/dynamic-large-object-creation.html
