...
require 'fog/identity/telefonica/v2/models/ec2_credential'

module Fog
  module Identity
    class TeleFonica
      class V2
        class Ec2Credentials < Fog::TeleFonica::Collection
          model Fog::Identity::TeleFonica::V2::Ec2Credential
          ...
          def find_by_access_key(access_key)
            ...
            unless ec2_credential
              ...
              ec2_credential = Fog::Identity::TeleFonica::V2::EC2Credential.new(body)
            end
