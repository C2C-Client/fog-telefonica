  ...
  module Compute
    class TeleFonica
      class Server < Fog::Compute::Server
        ...
        #                   }]
        # @see #create
        # @see http://docs.telefonica.org/api/telefonica-compute/2/content/Server_Personality-d1e2543.html
        ...
        def all_addresses
          # currently telefonica API does not tell us what is a floating ip vs a fixed ip for the vm listing,
        ...
        def security_groups
          if id
            ...
            groups.map do |group|
              Fog::Compute::TeleFonica::SecurityGroup.new group.merge(:service => service)
            end
          else
