...
require 'fog/image/telefonica/v1/models/image'
    ...
    class TeleFonica
      class V1
        class Images < Fog::TeleFonica::Collection
          model Fog::Image::TeleFonica::V1::Image
          ...
          def details(options = {}, deprecated_query = nil)
            Fog::Logger.deprecation("Calling TeleFonica[:glance].images.details will be removed, "\
          ...
          def find_by_id(id)
            ...
            new(params)
          rescue Fog::Image::TeleFonica::NotFound
            nil
          end
