...
module Fog
  module Network
    class TeleFonica
      ...
      #
      # @see http://docs.telefonica.org/api/telefonica-network/2.0/content/router_ext.html
      class Router < Fog::TeleFonica::Model
        identity :id
        ...
        def options
          ...
          if options[:external_gateway_info]
            if options[:external_gateway_info].kind_of?(Fog::Network::TeleFonica::Network)
