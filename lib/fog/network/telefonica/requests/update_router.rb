  ...
  module Network
    class TeleFonica
      class Real
        ...
        # @see http://docs.telefonica.org/api/telefonica-network/2.0/content/router_update.html
        def update_router(router_id, options = {})
          ...
          if egi
            if egi.kind_of?(Fog::Network::TeleFonica::Network)
      ...
      class Mock
        def update_router(router_id, options = {})
          ...
          raise Fog::Network::TeleFonica::NotFound unless router
