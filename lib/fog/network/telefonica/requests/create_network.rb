  ...
  module Network
    class TeleFonica
      class Real
        ...
        #
        # Not strictly required but commonly found in TeleFonica
        ...
        # Map Fog::Network::TeleFonica::Network
        # model attributes to TeleFonica provider attributes
        ALIASES = {
      ...
      class Mock
        def create_network(options = {})
          ...
          data.merge!(Fog::Network::TeleFonica::Real.create(options))
