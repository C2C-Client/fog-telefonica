...
module Fog
  module Network
    class TeleFonica < Fog::Service
      ...
      ## MODELS
      #
      model_path 'fog/network/telefonica/models'
      model       :extension
      ...
      ## REQUESTS
      #
      request_path 'fog/network/telefonica/requests'
      ...
      class Mock
        ...
        def data
          self.class.data["#{@telefonica_username}-#{@telefonica_tenant}"]
        end

        def reset_data
          self.class.data.delete("#{@telefonica_username}-#{@telefonica_tenant}")
        end
      end
      ...
      class Real
        ...
        def self.not_found_class
          Fog::Network::TeleFonica::NotFound
        end
