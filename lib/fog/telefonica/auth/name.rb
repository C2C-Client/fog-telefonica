    ...
    module Auth
      ...
      module Domain
        ...
        def identity
          ...
          if !id.nil?
            ...
            raise Fog::TeleFonica::Auth::CredentialsError,
      ...
      class Name
        def identity
          ...
          raise Fog::TeleFonica::Auth::CredentialsError, "#{self.class}: No available id or name"
        end
      ...
      class ProjectScope < Name
        include Fog::TeleFonica::Auth::Domain
