...
module Fog
  module TeleFonica
    class Collection < Fog::Collection
      ...
      def all(options = {})
        raise Fog::TeleFonica::Errors::InterfaceNotImplemented.new('Method :all is not implemented')
      end

      # Returns non detailed list of records, usually just subset of attributes, which makes this call more effective.
      # Not all telefonica services support non detailed list, so it delegates to :all by default.
      def summary(options = {})
        all(options)
      end
      ...
      def get(uuid)
        raise Fog::TeleFonica::Errors::InterfaceNotImplemented.new('Method :get is not implemented')
      end
      ...
      def destroy(uuid)
        raise Fog::TeleFonica::Errors::InterfaceNotImplemented.new('Method :destroy is not implemented')
      end
    end
  end
end
