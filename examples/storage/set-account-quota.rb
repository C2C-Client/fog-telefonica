...
# TeleFonica Storage service in Fog (See https://github.com/fog/fog/pull/1632).
#
...
# TeleFonica Grizzly (currently unreleased as of 2013/04/03).
#
# https://github.com/telefonica/swift/blob/master/swift/common/middleware/account_quotas.py
#
...
#
id = Fog::Identity::TeleFonica.new :telefonica_auth_url => auth_url,
...
#
st = Fog::Storage::TeleFonica.new :telefonica_auth_url => auth_url,
                                 :telefonica_username => user,
                                 :telefonica_api_key  => password
