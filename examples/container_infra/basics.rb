# TeleFonica Container Infra (Magnum) Example
require 'fog/telefonica'

# Initialize a connection to the Magnum API
params = {
  telefonica_auth_url:     'https://example.net/v3/auth/tokens',
  telefonica_username:     'username',
  telefonica_api_key:      'password',
  telefonica_project_name: 'magnum'
}

container_infra = Fog::ContainerInfra::TeleFonica.new(params)

# Get the Fedora Atomic image
image = Fog::Image::TeleFonica.new(params)
