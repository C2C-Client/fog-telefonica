...
# and upload it to Glance (the TeleFonica Image Service).
#
...
image_service = Fog::Image::TeleFonica.new :telefonica_api_key => ENV['OS_PASSWORD'],
                                          :telefonica_username => ENV["OS_USERNAME"],
                                          :telefonica_auth_url => ENV["OS_AUTH_URL"] + "/tokens",
                                          :telefonica_tenant => ENV["OS_TENANT_NAME"]
