...
describe "Fog::Identity[:telefonica] | EC2 credential requests" do
  before do
    ...
    @user_id = TeleFonica::Identity.get_user_id(@identity)
    @tenant_id = TeleFonica::Identity.get_tenant_id(@identity)
