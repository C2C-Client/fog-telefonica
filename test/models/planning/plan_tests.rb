...
describe "Fog::TeleFonica[:planning] | plan" do
  describe "success" do
    before do
      @planning = Fog::TeleFonica[:planning]
    ...
    it "#save" do
      @instance.save.must_be_kind_of Fog::TeleFonica::Planning::Plan
    end
    ...
    it "#create" do
      @instance.create.must_be_kind_of Fog::TeleFonica::Planning::Plan
    end
  end
end
