def collection_tests(collection, params = {})
  describe "success" do
    ...
    it "#create(#{params.inspect})" do
      unless Fog.mocking?
        @instance.must_be_kind_of Fog::Network::TeleFonica::SecurityGroup
      end
    end
    ...
    it "#all" do
      unless Fog.mocking?
        collection.all.must_be_kind_of Fog::Network::TeleFonica::SecurityGroups
      end
    end

    it "#get(#{@identity})" do
      unless Fog.mocking?
        collection.get(@identity).must_be_kind_of Fog::Network::TeleFonica::SecurityGroup
      end
    end
