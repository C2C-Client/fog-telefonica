...
describe Fog::SharedFileSystem::TeleFonica do
  spec_data_folder = 'spec/fixtures/telefonica/shared_file_system'

  before :all do
    telefonica_vcr = TeleFonicaVCR.new(
      :vcr_directory  => spec_data_folder,
      :project_scoped => true,
      :service_class  => Fog::SharedFileSystem::TeleFonica
    )
    @service = telefonica_vcr.service

    net_telefonica_vcr = TeleFonicaVCR.new(
      :vcr_directory  => spec_data_folder,
      :project_scoped => true,
      :service_class  => Fog::Network::TeleFonica
    )
    @network_service = net_telefonica_vcr.service
  end
