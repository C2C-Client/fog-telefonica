...
describe Fog::DNS::TeleFonica::V2 do
  spec_data_folder = 'spec/fixtures/telefonica/dns_v2'

  before :all do
    telefonica_vcr = TeleFonicaVCR.new(
      :vcr_directory  => spec_data_folder,
      :project_scoped => true,
      :service_class  => Fog::DNS::TeleFonica # Fog to choose latest available version
    )
